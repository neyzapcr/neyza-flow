  ...
  return (
    <div className="mb-5">
      ...
      <input
        ...
        value={value}
        onChange={onChange}
        className={`w-full max-w-[350px] rounded-xl border px-4 py-3 text-sm text-slate-700 placeholder:text-slate-400 outline-none transition-all duration-200 bg-white/90 ${
          error
