    ...
    Berikut ringkasan data pendaftaran kamu
      ...
      <div className="px-5 py-4">
        ...
        <div className="mt-4 flex justify-center gap-3">
          <button
            onClick={onReset}
            className="w-[60%] rounded-xl bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white 
...
function Row({ label, value }) {
  return (
    ...
    last:border-b-0 last:pb-0">
      ...
      <span className="max-w-[58%] wrap-break-word text-right text-sm font-semibold
       text-slate-800">
        {value}
      </span>
    </div>
